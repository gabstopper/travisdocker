...
from smc.core.interfaces import \
    _interface_helper, Interface, InterfaceBuilder, PhysicalInterface
...
class TestInterfaces(unittest.TestCase):
    ...
    def test_CviSubInterface(self):
        ...
        self.assertEqual(vars(cvi), cvi.data.get(cvi.typeof))
    ...
    def test_InlineSubInterface(self):
        ...
        called = n.data
        self.assertIsInstance(called, dict)
        self.assertEqual(called.get(n.typeof), vars(n))

        builder = InterfaceBuilder()
        builder.interface_id = '1-2'
        builder.add_vlan_to_inline(interface_id='1-2',
                                   vlan_id=5,
                                   vlan_id2=None,
                                   logical_interface_ref='http://1.1.1.1')

        for vlans in builder.vlanInterfaces:
        ...
        builder = InterfaceBuilder()
        builder.add_vlan_to_inline(interface_id='3-4',
                                   vlan_id=5,
                                   vlan_id2=6,
                                   logical_interface_ref='http://1.1.1.1')
        ...
        self.assertEqual(_add_vlan_to_inline(
            called, vlan_id=5, vlan_id2=6), called)
    ...
    def test_CaptureSubInterface(self):
        ...
        called = n.data
        self.assertIsInstance(called, dict)
        self.assertEqual(vars(n), n.data.get(n.typeof))
    ...
    def test_DHCPInterface(self):
        ...
        builder.add_dhcp(dynamic_index=1, is_mgmt=True)
        builder.zone_ref = 'http://1.1.1.1'

        self.assertEqual(builder.interface_id, 10)
        self.assertEqual(builder.zone_ref, 'http://1.1.1.1')
    ...
    def test_PhysicalInterface(self):
        ...
        builder.add_sni_only(
            address='1.1.1.1', network_value='1.1.1.0/24', is_mgmt=True)
        builder.zone_ref = 'http://1.1.1.1/ref'

        physical = PhysicalInterface()
        physical.data = SimpleElement(**builder.data)
        ...
        self.assertEqual(physical.aggregate_mode, None)
